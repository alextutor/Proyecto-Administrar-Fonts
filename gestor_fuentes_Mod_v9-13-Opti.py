...
class FontManagerApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Gestor Profesional de Fuentes - V19.3 (Personalización Avanzada)")
        
        # 1. Definir dimensiones deseadas
        ancho = 1350 # Ligeramente ampliado para acomodar los nuevos botones
        alto = 850
        ...
        # --- GRUPO IZQUIERDO (Opciones Básicas y Existentes) ---
        ...
        # --- GRUPO DERECHO (Nuevas Opciones Avanzadas Agrupadas) ---
        ...
        # Barra deslizante sincronizada con self.font_size_var
    ...
    # --- NUEVOS MÉTODOS DE PERSONALIZACIÓN DE COLOR ---
    ...
    def invert_colors(self):
        # Intercambia los colores actuales de texto y fondo
        self.current_text_color, self.current_bg_color = self.current_bg_color, self.current_text_color
        self.show_details(self.tree)

    def default_colors(self):
        # Restablece basado en el modo claro/oscuro actual
    ...
    def toggle_preview_mode(self):
        """Intercambia el esquema de color de la vista previa y actualiza variables (Claro <-> Oscuro)"""
    ...
    def generar_preview(self, font_path):
        # Utiliza las variables interactivas de color
        ...
        try:
            # Captura interactiva del tamaño seleccionado desde el Combobox o el Slider
