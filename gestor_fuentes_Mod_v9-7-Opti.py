# Implementamos en la parte inferior un boton al costado de cancelar scan 
# Desactivación Rápida de Fuentes Temporales (Limpiar Memoria). (Limpia todas la fuentes temporales que hemos cargado )
