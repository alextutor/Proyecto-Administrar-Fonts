# Si la fuente esta : Instalada se pondra de color verde , Activada temporalmente de color naranja
# Al hacer click derecho sobre la fuente podemos habilitar una opcion para instalarla , desistalarla o activarla temporalmente
#Activate Temporarily = Esto cargará las tipografías en la memoria de Windows para que puedas usarlas en tus #programas, pero se desactivarán automáticamente en cuanto apagues o reinicies el equipo.  
